...
import com.toedter.calendar.JDateChooser; // This package is used for calender for "Date of Issue".
import java.awt.event.*;
import java.sql.*;

public class Trial extends JFrame implements ActionListener{

    private JPanel contentPane;                                                // This is like container which holds all the things in it.
    JDateChooser dateChooser;                                                   // For Calender.
	...
	contentPane.add(b2);
        ...
        // Creating Panel for Border pupose.
	...
	contentPane.add(l15);
        ...
        // Creating 1 Data Chooser for selecting "Book Issue Date".
    ...
    @Override                                                                   // We are overiding the method of Interface "ActionListener" from which our class is extended.
    public void actionPerformed(ActionEvent ae) {                                // All logic is here. 
        
        try{
            conn con = new conn();
            
            if(ae.getSource() == b1)                                           // 1] If "Search" Button of Book Frame is clicked then fetched data and display is to the respective TextFeilds.
            {    
            ...
            if(ae.getSource() == b2)                                            //  2] If "Search" Button of Student Frame is clicked then fetched data and display is to the respective TextFeilds.
            {
		...
		rs.close();
            ...
            if(ae.getSource() == b3)                                            // 3] If "Issue" Button is clicked then put required data from above two frames into "Issue Book" table along with date of issue.
            {                                       
                try{
            ...
            if(ae.getSource() == b4){                                           // 4] It is "Back" Button.
