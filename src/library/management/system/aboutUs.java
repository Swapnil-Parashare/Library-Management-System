...
public class aboutUs extends JFrame{
	...
	private JPanel contentPane;
        ...
        public aboutUs() {
            ...
            JLabel l5 = new JLabel("DBMS Mini Project");
            l5.setForeground(new Color(30, 144, 255));
            l5.setFont(new Font("Trebuchet MS", Font.BOLD, 25));
            l5.setBounds(135, 140, 1000, 21);
            contentPane.add(l5);


            JLabel l6 = new JLabel("Developed By :- Group ID : 12");
            l6.setFont(new Font("Trebuchet MS", Font.BOLD, 30));
            l6.setBounds(70, 198, 600, 35);
            contentPane.add(l6);

            JTextArea l7 = new JTextArea("Technologies used : 1.Programing Language : Java \n\t         2.GUI : Swing \n\t         3.Server : WAMP \n\t         4.Database : MySql ");
