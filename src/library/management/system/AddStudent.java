/*
1] It's working is exactly same as "Add Book" Class.
2] There we were updating 'book' table, here we are updating 'student' table.
3] Here some more combo boxes are created that's it.
*/
