/******** It will display 'issuebook' and 'returnbook' table ************/
...
public class Statistics extends JFrame {
    ...
    // Getting all the data from "Issue Book" Table.
    ...
    // Getting all the data from "Return Book" Table.
	...
	contentPane.setLayout(null);
        ...
        JScrollPane scrollPane = new JScrollPane();                             // Note : ScrollPane is required for creating tables.
	...
	scrollPane.setViewportView(table);                                      // Adding table to "Scroll Pane".
        
        // Creating Panel for "Border" purpose.
	...
	contentPane.add(panel);
        ...
        // Creating Label "Back" which will act as a button.
	...
	contentPane.add(panel_1);
        ...
        // Calling issuebook() and returnbook() which will fetch data fram data base and inject it into respective table.
        issueBook();
	returnBook();     
    }   
}
